...
public interface KattaClientProtocol {
  ...
  /** 提交 */
  java.lang.Void comm(java.lang.CharSequence indexId) throws org.apache.avro.AvroRemoteException;
  /** 提交失败回滚 */
  java.lang.Void roll(java.lang.CharSequence indexId) throws org.apache.avro.AvroRemoteException;
  /** 关闭接口 */
  ...
  public interface Callback extends KattaClientProtocol {
    ...
    /** 提交 */
    void comm(java.lang.CharSequence indexId, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /** 提交失败回滚 */
    void roll(java.lang.CharSequence indexId, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /** 关闭接口 */
