...
public class CollectionUtil {
    ...
    public static List<String> getListOfAdded(final Collection<String> oldList,
                                              final Collection<String> updatedList) {
    ...
    private final static void extractAddedEntries(final Collection<String> oldCollection,
                                                  final Collection<String> updatedCollection,
                                                  final Collection<String> addedEntriesCollection) {
