...
public class Katta1 {
    ...
    protected final static Command help = new Command("help", "print out a help message") {
    ...
    protected static Command START_MASTER_COMMAND = new Command("startMaster",
    ...
    protected static Command ADD_INDEX_COMMAND = new ProtocolCommand("addIndex",
        ...
        public Options getOpts() {
            ...
            Options options = new Options();
            options.addOption("n", "name", true, "index name.");
    ...
    protected static Command ADD_SHARD_COMMAND = new ProtocolCommand("addShard",
        ...
        @Override
        public void process(CommandLine cl) throws Exception {
            this.indexName = cl.getOptionValue("n");
            this.path = cl.getOptionValue("p");
