...
import com.ivyft.katta.node.SocketExportHandler;
 ...
 * @author zhenqin
 */
public class KattaSerialSocketServer extends Thread implements Closeable {
     ...
     * 日志记录
     */
    private static Logger log = LoggerFactory.getLogger(KattaSerialSocketServer.class);


    public KattaSerialSocketServer(KattaLuceneServer luceneServer, NodeConfiguration nodeConfiguration) {
